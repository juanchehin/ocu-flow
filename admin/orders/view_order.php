...
<div class="content py-5 px-3 bg-gradient-dark">
	<h2><b><?= isset($code) ? $code : '' ?> Order Detalles</b></h2>
</div>
            ...
            <div class="card-header py-1">
                <div class="card-tools">
                    <?php if(isset($status) && $status < 4): ?>
                        <button class="btn btn-info btn-sm bg-gradient-info rounded-0" type="button" id="update_status">Actualizar Status</button>
                    <?php endif; ?>
                    ...
                    <a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=orders"><i class="fa fa-angle-left"></i> Volver to Listado</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="d-flex w-100 align-items-center">
            ...
            <div class="col-8">
                <div style="line-height:1em">
                    ...
                    <div class="text-center font-weight-bold"><large>order Detalles</large></div>
                </div>
            </div>
        </div>
...
<script>
    function print_t(){
        ...
        h.find('title').text("order Detalles - Print View")
    ...
    $(function(){
        ...
        $('#update_status').click(function(){
            uni_modal("Actualizar Status", "orders/update_status.php?id=<?= isset($id) ? $id : '' ?>")
        })
    })
