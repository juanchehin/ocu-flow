...
<div class="card card-outline rounded-0 card-dark">
			...
			<form action="" id="update-form">	
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<div class="form-group">
							<label for="middlename" class="control-label">Middle Nombre</label>
						...
						<div class="form-group">
							<label for="lastname" class="control-label">Last Nombre</label>
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-dark rounded-0 mr-3" form="update-form">Guardar User Detalles</button>
