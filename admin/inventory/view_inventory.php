		...
		<div class="card rounded-0">
			<div class="card-header py-1 text-center">
				<div class="card-tools">
					...
					<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=inventory"><i class="fa fa-angle-left"></i> Volver a Listado</a>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-7 col-sm-12 col-xs-12">
							<dl>
								...
								<dt class="text-muted h6 mb-0">HabilitadoStock</dt>
...
<script>
    $(function(){
		$('#new_entry').click(function(){
			uni_modal('<i class="far fa-plus-square"></i> Agregar New Stock Entry', 'inventory/manage_stock.php?pid=<?= isset($id) ? $id : '' ?>')
		})
		$('.edit_stock').click(function(){
			uni_modal('<i class="fa fa-edit"></i> Edit Stock Entry Detalles', 'inventory/manage_stock.php?pid=<?= isset($id) ? $id : '' ?>&id='+$(this).attr('data-id'))
		})
