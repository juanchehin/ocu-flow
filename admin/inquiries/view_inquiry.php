...
<div class="content bg-gradient-dark py-5 px-4">
    <h3 class="font-weight-bolder">Inquiry Detalles</h3>
</div>
    ...
    <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
        <div class="card card-outline card-primary rounded-0 shadow">
            ...
            <div class="card-footer py-1 text-center">
                ...
                <a class="btn btn-light btn-flat bg-gradient-light border btn-sm" href="./?page=inquiries"><i class="fa fa-angle-left"></i> Volver a Listado</a>
            </div>
        </div>
    </div>
</div>
