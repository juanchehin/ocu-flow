...
<div class="content py-5 px-3 bg-gradient-dark">
	<h2><b><?= isset($id) ? "Actualizar Categoria Detalles" : "New Categoria Entry" ?></b></h2>
</div>
	...
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-dark btn-sm bg-gradient-dark btn-flat" form="category-form"><i class="fa fa-save"></i> Guardar</button>
