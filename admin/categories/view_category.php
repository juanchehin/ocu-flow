	...
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			...
			<div class="card-footer py-1 text-center">
				...
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=categories"><i class="fa fa-angle-left"></i> Volver a Listado</a>
			</div>
		</div>
	</div>
</div>
