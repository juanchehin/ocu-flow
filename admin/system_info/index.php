...
<div class="col-lg-12">
	<div class="card card-outline rounded-0 card-dark">
		<div class="card-header">
			<h5 class="card-title">Sistema Informacion</h5>
			<!-- <div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-navy new_department" href="javascript:void(0)"><i class="fa fa-plus"></i> Agregar New</a>
			</div> -->
		</div>
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label">Sistema Nombre</label>
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label">Sistema Short Nombre</label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
				</div>
			<div class="form-group">
				<label for="" class="control-label">BienvenidoContent</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Sistema Logo</label>
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-dark" form="system-frm">Actualizar</button>
				</div>
			</div>
		</div>
