...
<div class="card card-outline rounded-0 card-dark">
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-dark" form="manage-user">Actualizar</button>
				</div>
			</div>
		</div>
</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp ==1){
					...
					$('#msg').html('<div class="alert alert-danger">Usuario already exist</div>')
					end_loader()
				}
			}
		})
