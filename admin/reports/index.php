                    ...
                    <table class="table table-bordered">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="px-1 py-1 text-center">Producto</th>
                                <th class="px-1 py-1 text-center">Unidad Precio</th>
        ...
        <div class="d-flex w-100 align-items-center">
            ...
            <div class="col-8">
                <div style="line-height:1em">
                    ...
                    <div class="text-center font-weight-bold h5 mb-0"><large>Daily Sales Reportes</large></div>
...
<script>
    function print_r(){
        ...
        h.find('title').text("Daily Reportes - Print View")
