...
<div class="content py-5 px-3 bg-gradient-dark">
	<h2><b><?= isset($id) ? "Actualizar Producto Detalles" : "New Producto Entry" ?></b></h2>
</div>
	...
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-dark btn-sm bg-gradient-dark btn-flat" form="product-form"><i class="fa fa-save"></i> Guardar</button>
				<a class="btn btn-light btn-sm bg-gradient-light border btn-flat" href="./?page=products"><i class="fa fa-times"></i> Cancelar</a>
			</div>
		</div>
	</div>
</div>
<script>
	...
	$(document).ready(function(){
		$('#category_id').select2({
			placeholder:"Please Select Categoria Here",
			width:'100%',
