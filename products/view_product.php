				...
				<div class="card rounded-0">
					<div class="card-body">
						<div class="container-fluid">
							...
							<dl>
								...
								<dt class="text-muted">HabilitadoStock</dt>
					...
					<div class="card-footer py-1 text-center">
						<?php if($_settings->userdata('id') != '' && $_settings->userdata('login_type') == 2): ?>
							<button class="btn btn-dark btn-sm bg-gradient-dark text-light rounded-0" type="button" id="add_to_cart"><i class="fa fa-cart-plus"></i> Agregar to Cart</button>
						<?php else: ?>
							<a class="btn btn-dark btn-sm bg-gradient-dark text-light rounded-0" href="./login.php" ><i class="fa fa-cart-plus"></i> Agregar to Cart</a>
						<?php endif; ?>
						<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?p=products"><i class="fa fa-angle-left"></i> Volver to Listado</a>
					</div>
				</div>
			</div>
		</div>
